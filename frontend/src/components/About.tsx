...
const About: React.FC = () => {
  return (
    <section className='flex flex-row flex-wrap justify-center text-white xl:pt-16 lg:pt-8 items-center xl:gap-24 2xl:gap-0 mt-20'>
